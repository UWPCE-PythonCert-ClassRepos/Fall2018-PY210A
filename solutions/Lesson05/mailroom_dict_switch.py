...
This was done by a student -- but presents a particularly nifty use of
using a dict to switch for the interactive loop
"""
...
def generate_letter(donor_name):
    ...
    """
    fs = "Thank you, {},\nfor your generosity and recent gift of ${}."
