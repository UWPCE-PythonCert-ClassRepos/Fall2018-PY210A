...
def test_make_report_strings():
    sum_donors=[['Bill Gates', [200.0, 600.0, 3]], ['Jack Frost', [69.0, 207.0, 3]], ['Maya Angelou', [7084.8533333333335, 21254.56, 3]]]
...
def test_make_sum_donors():
    ...
    test_sum_donors=[['Bill Gates', [200.0, 600.0, 3]], ['Jack Frost', [69.0, 207.0, 3]], ['Maya Angelou', [7084.8533333333335, 21254.56, 3]]]
...
def test_make_total_donors():
    ...
    test_total_donors=[
    ['Bill Gates', 600.0, 'Bill_Gates.txt'],
...
def test_thank_donor_msg():
    ...
    test_thank_donor_msg_string=('Dear Brian Nisonger, Thank you for your donation of $600.00.'
    'These funds help save the migratory butterflies of New South East.Thank you')
