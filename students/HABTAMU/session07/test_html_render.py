...
def test_p():
    # e = P("this is some text", "text-align"="center", "id"="intro")
...
def test_attributes():
    ...
    e = P("A paragraph of text",  id="intro", style= "text-align: center")
...
def test_hr():
    ...
    print(file_contents)
    assert file_contents in '<hr />\n'

def test_one_line_tag_render():
    one_tag = A("http://google.com", "google link")
    file_contents = render_result(one_tag)
    print(file_contents)
    assert file_contents in '<a href="http://google.com">google link</a> '
...
def test_hr_attr():
    ...
    file_contents = render_result(hr)
    print(file_contents)
    assert file_contents in '<hr width="400" />\n'
