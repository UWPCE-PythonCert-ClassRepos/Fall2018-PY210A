...
try:
    ...
    print("Silly user, you can't print a variable that you haven't defined.")
...
try:
    another_joke = more_fun(langs[1])
    more_joke = more_fun(langs[2])
    last_joke = last_fun()
except IndexError:
    print("Silly hooman, you can't index items that don't actually exist.")
