...
#Part 3: Exception Update
#1. Improve your mailroom by adding exceptions and comprehensions.
#2. Now that you’ve learned about exception handling, you can update your 
#code to handle errors better, such as when a user inputs bad data.
#3. Comprehensions- Can you use comprehensions to clean up your code a bit?
#4. Note: you may be tempted to replace loops like this:
