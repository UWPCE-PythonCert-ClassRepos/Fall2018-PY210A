...
def sum_series(n,n2 = 0,n3 = 1):
    """This is the sum seires function that will return the nth value of a series of numbers. 1st option returns the nth number and the 2nd and 3rd option is the beginning of the series. Default is 0 and 1 for fibonacci"""
    a=n2
    b=n3
    #comment out all but the last of the print statements if you don't want to see the count increase
    #print(a)
